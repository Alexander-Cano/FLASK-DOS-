...
R: Una crea, otra lee, otra actualiza y la ultima borra información
2. ¿Por que es importante tener ForeignKey entre Tarea y Usuario?
R: Para que tenga una contraseña la informacion
3. ¿Como protegearias la ruta de crear tarea para que solo profesor pueda?
R: Con el código que limita el acceso unicamente al rol de profesor
