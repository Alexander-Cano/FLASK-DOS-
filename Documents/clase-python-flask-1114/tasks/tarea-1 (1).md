...
R: Es el ejecutable que pone a correr el entorno virtual
2. ¿Por que necesitas el entorno virtual (.venv)?
R: Es la carpeta necesaria para correr la libreria flask
3. ¿Donde se almacena el HTML que ves en el navegador?
R: En la carpeta Templates
4. Si cambias el HTML sin guardar, ¿se refleja el cambio en el navegador? ¿Por que?
R: No se refleja ya que la página está interconectada a flask
5. ¿Que es render_template y por que Flask lo usa?
R: Es la renderizacion de la carpeta template y flask lo usa para correr y renderizar la página
